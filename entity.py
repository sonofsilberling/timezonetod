...
class TimezoneTodSensorCore:
    ...
    @property
    def is_child(self) -> bool: return self._is_child
    @property
    def calculated_start_utc(self) -> Optional[datetime]: return self._calculated_start_utc
    @property
    def calculated_end_utc(self) -> Optional[datetime]: return self._calculated_end_utc
    @property
    def next_update_utc(self) -> Optional[datetime]: return self._next_update_utc
    @property
    def parent_entity_id(self) -> Optional[str]: return self._parent_entity_id
    @property
    def start_offset(self) -> timedelta: return self._start_offset
    @property
    def end_offset(self) -> timedelta: return self._end_offset
    @property
    def timezone_name(self) -> Optional[str]:
        """Return the configured timezone string."""
        return self._configured_timezone_str    
    ...
    def update_boundaries(
        ...
        if self._is_child:
            ...
            try:
                ...
                p_start = datetime.fromisoformat(parent_attributes.get("start_time_utc"))
    ...
    def _resolve_time(self, config_val: str, ref_date: any, tz: tzinfo, sun_callback: callable) -> datetime:
